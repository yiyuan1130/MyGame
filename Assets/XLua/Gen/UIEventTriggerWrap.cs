...
namespace XLua.CSObjectWrap
{
    ...
    public class UIEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddListerner", _m_AddListerner);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddListerner(RealStatePtr L)
        {
		    try {
                ...
                {
                    UIEventTrigger.EventType _type;translator.Get(L, 2, out _type);
                    System.Action<UnityEngine.EventSystems.PointerEventData> _action = translator.GetDelegate<System.Action<UnityEngine.EventSystems.PointerEventData>>(L, 3);
                    
                    gen_to_be_invoked.AddListerner( _type, _action );
        ...
        static int _m_RemoveListener(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RemoveListener( _type, _action );
